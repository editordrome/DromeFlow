...
const AgendaExternaPage: React.FC = () => {
            ...
            {disponibilidadeEnviada.map(d => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-[11px] font-[900] px-4 py-2 rounded-full uppercase tracking-widest ${
                    isNao
  ...
  return (
    <div className="min-h-screen bg-bg-primary text-text-primary flex flex-col font-sans relative">
      ...
      <div className="flex-1 w-full max-w-md mx-auto px-6 pt-6 pb-8 flex flex-col pt-10">
