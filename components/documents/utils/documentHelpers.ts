...
export function prepareDocumentData(
    ...
    return {
        ...
        unidade: {
            razaoSocial: unidadeData.razao_social || (unidadeData as any).razaoSocial || '',
            ...
            unitName: unidadeData.unit_name || (unidadeData as any).unitName || '',
            unitCode: unidadeData.unit_code || (unidadeData as any).unitCode || '',
            uniformValue: (unidadeData as any).uniform_value || (unidadeData as any).uniformValue || 0,
            id: unidadeData.id || (unidadeData as any).id || '',
        },
        contrato: {
